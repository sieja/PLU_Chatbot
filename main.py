...
from utils.backend.pdf_process import pdf_process
import os
import json
...
from utils.entities import Corpus, Document
...
st.set_page_config(page_title="PLU Chatbot", page_icon="🤖")
st.title("PLU Chatbot")
st.write("Welcome to the PLU Chatbot! Start chatting below.")

if not os.path.exists(pdf_path_cleaned):
    pdf_process(pdf_path)
